...
def get_parser():
    ...
    parser.add_argument('--ck_bert', default='/home/jim/nas/zhangyijie/MVP-main/bert-base-uncased', help='pre-trained BERT weights')
    ...
    parser.add_argument('--device', default='cuda:7', help='device')  # only used when testing on a single machine
    ...
    parser.add_argument('--lr', default=3e-5, type=float, help='the initial learning rate')   # 5e-5 for RefSegRS, 3e-5 for RRSIS-D
    parser.add_argument('--mha', default='', help='If specified, should be in the format of a-b-c-d, e.g., 4-4-4-4,'
                                                  ...
                                                  'stage-2, stage-3, and stage-4 PWAMds')
    ...
    parser.add_argument('--output-dir', default='/home/jim/nas/zhangyijie/checkpoints1024/', help='path where to save checkpoint weights')
    parser.add_argument('--pin_mem', action='store_true',
                        help='If true, pin memory when using the data loader.')
    parser.add_argument('--pretrained_swin_weights', default='/media/ssd/zhangyijie/RMSIN-main/swin_base_patch4_window12_384_22k.pth',
                        help='path to pre-trained Swin backbone weights')
    parser.add_argument('--print-freq', default=10, type=int, help='print frequency')
    parser.add_argument('--refer_data_root', default='/media/ssd/zhangyijie/FIANet-master/FIANet-master/RefSegRS/RefSegRS', help='REFER dataset root directory')
